...
class StarCounter:
    def __init__(self, fits_file_name):
        ...
        self.image_data = self.fits_manager.image_data
        self.image_data_formatted = np.array(self.image_data, dtype=float)
        self.image_mask = self.fits_manager.image_mask
        self.data_sub_bkg = None

        self.star_objects = StarCounter.run_sep_extractor(self)
